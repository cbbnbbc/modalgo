...
UUID = os.environ.get('UUID', '063a7386-e576-4a10-a8ce-bb151022a260')       # UUID
...
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'fr.qcy.cloudns.org')                             # 国定隧道域名，留空即启用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiOTgwMTg1OWM4YzdlNDdiNmE4M2I0YmIwOWE0ZTRjOWIiLCJ0IjoiZDYxMjY2MzEtMGUzZi00ZjhlLTk2ODAtMzZlNThkZDY2YTJmIiwicyI6IlpESXdPR1F5WVdZdFpqWm1PUzAwTnpKbUxXSXdaVE10TmpReVlqRm1NRFF6T0dJdyJ9')                                 # 国定隧道json或token，留空即启用临时隧道,json获取地址：https://fscarmen.cloudflare.now.cc
